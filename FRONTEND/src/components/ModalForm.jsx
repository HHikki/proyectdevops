...
export default function ModalForm({ open, onClose, level }) {
  ...
  return (
    ...
    >
      <div
        className="relative bg-white bg-opacity-95 w-full max-w-md mx-auto rounded-3xl shadow-2xl border-2 border-[#003049]
        animate-modal-pop"
        style={{
      ...
      >
        ...
        <form className="flex flex-col gap-5 px-8 pb-8">
          {[
            { label: "Nombre Completo", placeholder: "Insertar nombre completo", id: "nombre" },
            { label: "DNI", placeholder: "Insertar DNI", id: "dni" },
            { label: "Teléfono", placeholder: "Insertar teléfono", id: "telefono" },
            { label: "Correo", placeholder: "Insertar correo", id: "correo", type: "email" },
            { label: "Grado", placeholder: "Insertar grado", id: "grado" },
