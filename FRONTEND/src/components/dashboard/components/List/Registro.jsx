...
const Registro = ({ layoutMode = 0, tipo }) => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      // Actualizar la tabla removiendo el elemento eliminado
      setData((prevData) =>
        prevData.filter((item) => item.key !== selectedKey.key)
      );
  ...
  // Extraer fetchData para poder reutilizarla
