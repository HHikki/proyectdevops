...
export default function NewPublicationModal({ isOpen, onClose }) {
  ...
  return (
    <ModalWrapper isOpen={isOpen} onClose={onClose}>
      <h2 className="text-2xl font-semibold mb-1">Nueva Publicación</h2>
      <p className="mb-6 text-gray-500">Crea una nueva noticia para el colegio</p>
