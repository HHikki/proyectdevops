...
export default function NewCommunicationModal({ isOpen, onClose }) {
  ...
  return (
    <ModalWrapper isOpen={isOpen} onClose={onClose}>
      <h2 className="text-2xl font-semibold mb-1">Nuevo Comunicado</h2>
      <p className="mb-6 text-gray-500">Crea un nuevo comunicado para padres y estudiantes</p>
